...
s:"Esc"},About:{t:"\u5173\u4e8e xhEditor"}},Ia={mini:"Bold,Italic,Underline,Strikethrough,|,Align,List,|,Link,Img",simple:"Cut,Copy,Paste,Pastetext,|Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,|,Align,List,Outdent,Indent,|,Link,Img,Hr,|,Source,Preview,Fullscreen",full:"Cut,Copy,Paste,Pastetext,|,Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,|,Align,List,Outdent,Indent,|,Link,Unlink,Anchor,Img,Flash,Media,Hr,Emot,Table,|,Source,Preview,Print,Fullscreen"};
