...
var SELF = '/goods/Seller/Log/lst.html';
var URL = '/goods/Seller/Log';
var APP	 =	 '/goods';
    ...
    <div class="container-fluid">
		...
		<span class="icon">
			<i class="icon-th-list"></i>
                        ...
                        <div class="buttons">
                            <a title="新建类别" class="btn btn-mini" href="<?php echo U('add');?>"><i class="icon-plus"></i></a>
                        </div>
                    </div>
                            ...
                            <div>
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="list_data_<?php echo ($vo["id"]); ?>" class="center">
                                            ...
                                            <td><?php echo ($vo['type'] == 1?'进库':'出库'); ?></td>
