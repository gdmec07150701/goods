...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'最后一页','theme'=>'<ul><li><a>%totalRow% %header% %nowPage%/%totalPage% 页 </a></li>%first%%upPage%%linkPage%%downPage%%end%</ul>');
